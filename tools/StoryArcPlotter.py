...
#
# This program makes use of the AFINN sentiment dataset by Finn Arup Nielsen, under the "Open Database License (ODbL) v1.0"<http://www.opendatacommons.org/licenses/odbl/1.0/>.
...
def ui():
	...
	while selecting:
		...
		try:
			...
			print (list(links.keys())[choice-1])
